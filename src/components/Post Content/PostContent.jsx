        ...
        <div className="content-container">
                                ...
                                src={
                                    type === "detail"
                                        ? data.author.profile_image
                                            ? `https://api-discusspedia.herokuapp.com/${data.author.profile_image}`
                                            : Photo
                                        : data.author_avatar
                                        ? `https://api-discusspedia.herokuapp.com/${data.author_avatar}`
                                        : Photo
                                }
                                alt="user"
                                width={"50rem"}
                ...
                <div className="content">
                    ...
                    {type === "detail" &&
                        ...
                        data.images.map((image, index) => {
                            return <img key={index} src={`https://api-discusspedia.herokuapp.com/${image.url}`} alt="Description" />;
                        })}
            ...
            <div id="bottom-section" className={type === "post" ? "post-content" : "detail-content"}>
                {type === "post" && (
                    <div className="user-section">
                        <div className="user-avatar">
                            <img src={data.author.profile_image ? `https://api-discusspedia.herokuapp.com/${data.author.profile_image}` : Photo} alt="user" />
                        </div>
                        <div className="user-info">
