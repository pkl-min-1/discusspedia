                    ...
                    <div className="modal">
                        <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                            ...
                            <DialogContent dividers>
                                <img src={profileResult.avatar ? `https://api-discusspedia.herokuapp.com/${profileResult.avatar}` : FotoProfile} alt="Profile" width={"60px"} height={"65px"} style={{ borderRadius: "50%" }} />
